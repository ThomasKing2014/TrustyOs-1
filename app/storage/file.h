...
void *file_get_block_write(struct transaction *tr, struct file_handle *file,
                           ...
                           obj_ref_t *ref);
void *file_get_block_new(struct transaction *tr, struct block_map *block_map,
                         struct block_mac  *file_block_mac, data_block_t file_block,
                         bool read, bool write, obj_ref_t *ref);
void file_block_map_update(struct transaction *tr, struct block_map *block_map,
                           struct file_handle *file);
void file_block_map_init(struct transaction *tr, struct block_map *block_map,
